...
characterDict = {
    ...
    melee.Character.JIGGLYPUFF : "framedata-json-fullhitboxes/Ice Climbers - Nana.framedata.json",
    melee.Character.KIRBY : "framedata-json-fullhitboxes/Ice Climbers - Popo.framedata.json",
    melee.Character.LINK : "framedata-json-fullhitboxes/Jigglypuff.framedata.json",
    melee.Character.LUIGI : "framedata-json-fullhitboxes/Kirby.framedata.json",
    melee.Character.MARIO : "framedata-json-fullhitboxes/Link.framedata.json",
    melee.Character.MARTH : "framedata-json-fullhitboxes/Luigi.framedata.json",
    melee.Character.MEWTWO : "framedata-json-fullhitboxes/Mario.framedata.json",
    melee.Character.NANA : "framedata-json-fullhitboxes/Marth.framedata.json",
    melee.Character.NESS : "framedata-json-fullhitboxes/Mewtwo.framedata.json",
    melee.Character.PEACH : "framedata-json-fullhitboxes/Ness.framedata.json",
    melee.Character.PICHU : "framedata-json-fullhitboxes/Peach.framedata.json",
    melee.Character.PIKACHU : "framedata-json-fullhitboxes/Pichu.framedata.json",
    melee.Character.POPO : "framedata-json-fullhitboxes/Pikachu.framedata.json",
