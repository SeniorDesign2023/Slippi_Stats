...
#sometimes he just straight up kneels for no reason
#when he approaches, he will simply hit once and then continue
    #make him stop and continue to attack
#after he has used C once, you have to jump to make him do it again
    #otherwise he just walks back and forth and throws boomerangs
...
while True:
    ...
    if gamestate.menu_state in [melee.Menu.IN_GAME, melee.Menu.SUDDEN_DEATH]:
            ...
            elif (heightDif > -5) and (heightDif < 21): #if on the same height
